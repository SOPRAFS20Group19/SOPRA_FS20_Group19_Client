                    ...
                    <Container3>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({holz: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.holz === "Y"}
                                onClick={() => {
                                    this.props.setState({holz: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container3>
                    <Container4>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({rost: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.rost === "Y"}
                                onClick={() => {
                                    this.props.setState({rost: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container4>
                    <Container5>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({tisch: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.tisch === "Y"}
                                onClick={() => {
                                    this.props.setState({tisch: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container5>
                    <Container6>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({trinkwasser: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.trinkwasser === "Y"}
                                onClick={() => {
                                    this.props.setState({trinkwasser: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container6>
                    <Container7>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({abfall: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.abfall === "Y"}
                                onClick={() => {
                                    this.props.setState({abfall: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container7>
                    <Container8>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({parkplatz: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.parkplatz === "Y"}
                                onClick={() => {
                                    this.props.setState({parkplatz: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container8>
                    <Container9>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({baden: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.baden === "Y"}
                                onClick={() => {
                                    this.props.setState({baden: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container9>
                    <Container10>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({hunde: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.hunde === "Y"}
                                onClick={() => {
                                    this.props.setState({hunde: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container10>
                    <Container11>
                        ...
                        <ButtonContainerYesNo>
                            <ButtonYesNo
                                ...
                                onClick={() => {
                                    this.props.setState({kinderwagen: "X"});
                                }}>Yes
                            </ButtonYesNo>
                            <ButtonYesNo
                                disabled={this.props.kinderwagen === "Y"}
                                onClick={() => {
                                    this.props.setState({kinderwagen: "Y"});
                                }}>No
                            </ButtonYesNo>
                        </ButtonContainerYesNo>
                    </Container11>
                    <Container12>
                        <ButtonContainer>
                            <Button
                                ...
                                onClick={() => {
                                    this.props.saveChangesFireplace()
                                }}>Save Location
                            </Button>
                        </ButtonContainer>
                        <ButtonContainer>
